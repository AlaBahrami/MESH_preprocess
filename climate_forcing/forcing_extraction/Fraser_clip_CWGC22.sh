	 ...
	 for P in {1..5}
	  do
		...
		for var in hus pr ps rlds rsds ta wind 
			do
				cdo -z zip setmisstonn $outfolder/$basin"_"$var"_r"${R}"i2p1r"${P}"_z1_1951-2100.Feb29".nc4 tmp2.nc
				rm $outfolder/$basin"_"$var"_r"${R}"i2p1r"${P}"_z1_1951-2100.Feb29".nc4
				mv tmp2.nc $outfolder/$basin"_"$var"_r"${R}"i2p1r"${P}"_z1_1951-2100.Feb29".nc4
			done
	  done
	done
